...
while (otvet != "пока") and (otvet != "досвидания") and (otvet != "прощай"):
    ...
    if "животных" in otvet:
        ...
        otvet = input().lower()
        while (otvet != "пока") and\
                (otvet != "досвидания")\
                and (otvet != "прощай"):
            if ("не" in otvet) or\
                    ("нет" in otvet) or ("бесят" in otvet):
                print("А давайте сменим тему?")
                break
            if ("да" in otvet) or\
                    ("нравятся" in otvet) or ("очень" in otvet):
                print("Когда коты мурчат, они могут вылечить вас!!!"
                      " Это факт.")
                break
        ...
        print("Техника вокруг вас, наример я."
              " Вы часто пользуетесь гаджетами?")
        otvet = input().lower()
        while (otvet != "пока") and\
                (otvet != "досвидания") and (otvet != "прощай"):
            if ("да" in otvet) or\
                    ("часто" in otvet) or ("почти всегда" in otvet):
        ...
        while (otvet != "пока") and (otvet != "досвидания") and (otvet != "прощай"):
            if ("да" in otvet) or ("часто" in otvet) or ("каждый день" in otvet):
                print("Это класно и полезно, но не перегружайтесь!!! Это вредно.")
                break
            elif ("нет" in otvet) or ("редко" in otvet) or ("ниразу не ходил" in otvet) or\
                    ("не " in otvet):
                print("Советую вам делать физические упражнения почаще."
                      " Тело будет красивое.")
                break
        ...
        while (otvet != "пока") and (otvet != "досвидания") and (otvet != "прощай"):
            if ("да" in otvet) or ("очень" in otvet) or ("жить без него немогу" in otvet):
                print("Я его тоже люблю. Но много есть ненадо.")
                break
